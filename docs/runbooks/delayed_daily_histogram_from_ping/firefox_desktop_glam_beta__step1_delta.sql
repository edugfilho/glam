...
--   --destination_table=firefox_desktop_glam_beta__clients_histogram_aggregates_new_v1 \
--   --parameter=submission_date:DATE:$SUBMISSION_DATE \
--   --reservation_id=moz-fx-bigquery-reserv-global:US.glam \
--   < firefox_desktop_glam_beta__step1_delta.sql
SELECT * FROM (
WITH extracted_daily AS (
  ...
  FROM
    moz-fx-glam-prod.glam_etl.firefox_desktop_glam_beta__view_clients_daily_histogram_aggregates_v1,
